...
sl_zigbee_event_t battery_monitor_read_ADC_event;

extern void emberAfPluginBatteryMonitorV2ReadADCEventHandler();
...
void emberAfMainInitCallback(void)
{
  ...
  sl_zigbee_event_init(&battery_monitor_read_ADC_event,emberAfPluginBatteryMonitorV2ReadADCEventHandler);
  emberAfPluginBatteryMonitorV2InitCallback();  // Plugin: battery-monitor-v2
}
