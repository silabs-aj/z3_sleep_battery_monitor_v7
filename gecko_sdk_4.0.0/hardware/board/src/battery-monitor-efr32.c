...
#include "../inc/battery-monitor.h"
#include "/Users/alji/SimplicityStudio/SDKs/gecko_sdk/util/plugin/plugin-common/generic-interrupt-control/generic-interrupt-control.h"
#include "em_cmu.h"

#if defined(_SILICON_LABS_32B_SERIES_2)
#include "/Users/alji/SimplicityStudio/SDKs/gecko_sdk/platform/emlib/inc/em_iadc.h"
#else
#include "em_adc.h"
#endif

#include "/Users/alji/SimplicityStudio/SDKs/gecko_sdk/platform/emlib/inc/em_prs.h"
...
#define EMBER_AF_PLUGIN_BATTERY_MONITOR_V2_TX_ACTIVE_PRS_CH 6
#define EMBER_AF_PLUGIN_BATTERY_MONITOR_V2_TX_ACTIVE_PORT GPIO_PORT_C
#define EMBER_AF_PLUGIN_BATTERY_MONITOR_V2_TX_ACTIVE_PIN 0
#define EMBER_AF_PLUGIN_BATTERY_MONITOR_V2_TX_ACTIVE_LOC 0
#define EMBER_AF_PLUGIN_BATTERY_MONITOR_V2_MONITOR_TIMEOUT_M 1
#define EMBER_AF_PLUGIN_BATTERY_MONITOR_V2_SAMPLE_FIFO_SIZE 16

// Shorter macros for plugin options
#define FIFO_SIZE \
  EMBER_AF_PLUGIN_BATTERY_MONITOR_V2_SAMPLE_FIFO_SIZE
#define MS_BETWEEN_BATTERY_CHECK \
 (EMBER_AF_PLUGIN_BATTERY_MONITOR_V2_MONITOR_TIMEOUT_M*60)
...
extern sl_zigbee_event_t battery_monitor_read_ADC_event;
...
void halBatteryMonitorInitialize(void)
{
  ...
  halGenericInterruptControlIrqEventRegister(
    irqConfig,
    &battery_monitor_read_ADC_event);
...
void emberAfPluginBatteryMonitorV2ReadADCEventHandler(void)
{
  ...
  sl_zigbee_event_set_inactive(&battery_monitor_read_ADC_event);

//  emberAfAppPrintln("TX:");
