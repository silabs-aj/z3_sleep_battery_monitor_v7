...
#include "/Users/alji/SimplicityStudio/SDKs/gecko_sdk/protocol/zigbee/app/framework/common/zigbee_app_framework_event.h"
#include "generic-interrupt-control.h"
#include "hal/hal.h"
#include "/Users/alji/SimplicityStudio/SDKs/gecko_sdk/platform/service/legacy_hal/inc/micro-common.h"
...
static void genericIsr(uint8_t pin)
{
  ...
  if (irqConfigs[pin].irqEventHandler != NULL) {
      sl_zigbee_event_set_active(irqConfigs[pin].irqEventHandler);
  }
}
